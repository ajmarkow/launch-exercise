  ...
  customElements.define(
    ...
    class QuickAddModal extends ModalDialog {
      ...
      show(opener) {
        ...
        fetch(opener.dataset.productUrl)
          ...
          .then((responseText) => {
            ...
            this.modalContent
              .querySelector("product-component")
              ?.dispatchViewEvent?.();
      ...
      preventVariantURLSwitching(productElement) {
        productElement.dataset.updateUrl = "false";
      }
      ...
      preventDuplicatedIDs(productElement) {
        ...
        productElement.innerHTML = productElement
          .getHTML()
          .replaceAll(oldId, newId);
        for (const attribute of productElement.attributes) {
